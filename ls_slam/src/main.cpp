...
int main(int argc, char **argv)
{
    ...
    // std::string VertexPath = "/home/fengyusu/catkin_ws/src/lidar_slam/ls_slam/data/test_quadrat-v.dat";
    // std::string EdgePath = "/home/fengyusu/catkin_ws/src/lidar_slam/ls_slam/data/test_quadrat-e.dat";

    std::string VertexPath = "/home/fengyusu/catkin_ws/src/lidar_slam/ls_slam/data/intel-v.dat";
    std::string EdgePath = "/home/fengyusu/catkin_ws/src/lidar_slam/ls_slam/data/intel-e.dat";
    ...
    for(int i = 0; i < maxIteration;i++)
    {
        ...
        for(int v_index = 0; v_index < Vertexs.size(); v_index++)
        {
            Vertexs[v_index] += dx.block(3 * v_index, 0, 3, 1);
        }
